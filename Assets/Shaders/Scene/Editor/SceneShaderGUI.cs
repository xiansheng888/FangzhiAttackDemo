...
public class SceneShaderGUI : ShaderGUI
{
    ...
    private static class Styles
    {
        ...
        public static GUIContent metallicMapText = EditorGUIUtility.TrTextContent("Metallic", "Metallic (R), Smoothness (G), Emmision (B), Occlusion(A)");
    ...
    WorkflowMode m_WorkflowMode = WorkflowMode.Dielectric;
    ...
    internal void DetermineWorkflow(Material material)
    {
        ...
        if (ShaderHasProperty(shader, _MetallicGlossMap) && ShaderHasProperty(shader, _Metallic))
            m_WorkflowMode = WorkflowMode.Metallic;
        else
            m_WorkflowMode = WorkflowMode.Dielectric;
    }
    ...
    void DoEmissionArea(Material material)
    {
        ...
        if (true)
        {
            ...
            bool hadEmissionTexture = metallicMap.textureValue != null;

            // Texture and HDR color controls
            m_MaterialEditor.ColorProperty(emissionColorForRendering, "emission color");

            // If texture was assigned and color was black set color to white
            float brightness = emissionColorForRendering.colorValue.maxColorComponent;
            if (metallicMap.textureValue != null && !hadEmissionTexture && brightness <= 0f)
