...
////// Lighting:
                ...
                float3 finalColor = (_MainTex_var.rgb*_Color.rgb*i.vertexColor.rgb*(_MainTex_var.a*_Color.a*i.vertexColor.a*_Mask_var.r)*3.0);
