...
////// Lighting:
                ...
                return fixed4(finalColor,(_MainTex_var.a*_Color.a*i.vertexColor.a*saturate(((_DissolveTex_var.r*_Softness)-lerp(_Softness,(-1.5),i.uv1.r)))));
            }
            ENDCG
        }
        Pass {
