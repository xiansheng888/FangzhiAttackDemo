...
Shader "Shader Forge/Add_UVmove02" {
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform sampler2D _Mask_fixed; uniform float4 _Mask_fixed_ST;
            struct VertexInput {
...
////// Lighting:
                ...
                float4 _Mask_fixed_var = tex2D(_Mask_fixed,TRANSFORM_TEX(i.uv0, _Mask_fixed));
                float3 finalColor = (_MainTex_var.rgb*_Color.rgb*i.vertexColor.rgb*(_MainTex_var.a*_Color.a*i.vertexColor.a*_Mask_var.r*_Mask_fixed_var.r));
